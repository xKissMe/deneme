...
client.login(config.token).then(console.log(`Bot başarıyla giriş yaptı!`)).catch(console.error("Bota giriş yapılırken başarısız olundu tokeni dogru girdigine emin misin ?"));